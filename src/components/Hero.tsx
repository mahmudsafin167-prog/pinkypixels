...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-[85vh] md:min-h-screen flex items-center justify-center pt-20 overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6 text-center flex flex-col items-center justify-center pt-10 md:pt-20 pb-32">
                {/* 1. RECRUITING BADGE */}
                <div
                ...
                <div
                    ...
                    data-aos-delay="400"
                >
                    <motion.div whileTap={{ scale: 0.95 }} className="w-full sm:flex-1 relative z-20">
                        <Link
                            href="/auth/login"
                            onClick={handleJoinClick}
                            className="w-full h-full bg-primary hover:bg-primary-dark text-white px-8 py-5 md:py-6 rounded-2xl text-lg md:text-xl font-black transition-all flex items-center justify-center gap-3 shadow-glow italic skew-x-[-5deg] tracking-widest block"
                        >
                            <span className="material-symbols-outlined text-2xl md:text-3xl block">sports_esports</span>
                            <span className="block">JOIN GUILD</span>
                        </Link>
                    </motion.div>
                    ...
                    <motion.div whileTap={{ scale: 0.95 }} className="w-full sm:flex-1 relative z-20">
                        <Link
                            ...
                            className="w-full h-full gaming-card-light text-white px-8 py-5 md:py-6 rounded-2xl text-lg md:text-xl font-black transition-all border border-white/20 flex items-center justify-center gap-3 italic skew-x-[-5deg] tracking-widest block"
                        >
                            <span className="material-symbols-outlined text-2xl md:text-3xl block">group</span>
                            <span className="block">VIEW MEMBERS</span>
                        </Link>
                    </motion.div>
                </div>
            </div>
