...
export default function SpecialLeaderCard() {
    return (
        <Tilt
            ...
            gyroscope={false}
            className="col-span-2 lg:col-span-4 lg:w-1/3 lg:mx-auto"
        >
            <div
                className="leader-glow-card rounded-[2.5rem] overflow-hidden relative flex flex-col items-center p-8 transition-all duration-500 h-auto md:h-[550px]"
                data-aos="zoom-in"
            >
