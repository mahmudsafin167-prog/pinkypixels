...
export default function Activities() {
    return (
        <section className="py-12 md:py-20 px-4" id="activities">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide -mx-4 px-4 gap-4 md:grid md:grid-cols-3 md:gap-6 md:mx-0 md:px-0 pb-4 md:pb-0 after:content-[''] after:w-4 after:flex-none md:after:content-none">
                    {/* Card 1 */}
                    <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2000} gyroscope={false} className="w-[85vw] md:w-auto flex-none snap-center">
                        <div data-aos="fade-up" data-aos-delay="100" className="group relative h-80 rounded-2xl overflow-hidden cursor-pointer shadow-glow-sm hover:shadow-glow transition-all">
                    ...
                    {/* Card 2 */}
                    <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2000} gyroscope={false} className="w-[85vw] md:w-auto flex-none snap-center">
                        <div data-aos="fade-up" data-aos-delay="200" className="group relative h-80 rounded-2xl overflow-hidden cursor-pointer shadow-glow-sm hover:shadow-glow transition-all">
                            <div className="absolute inset-0 bg-gradient-to-t from-black via-primary/20 to-primary/5 z-10 opacity-90"></div>
                            <img
                    ...
                    {/* Card 3 */}
                    <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2000} gyroscope={false} className="w-[85vw] md:w-auto flex-none snap-center">
                        <div data-aos="fade-up" data-aos-delay="300" className="group relative h-80 rounded-2xl overflow-hidden cursor-pointer shadow-glow-sm hover:shadow-glow transition-all">
                            <div className="absolute inset-0 bg-gradient-to-t from-black via-primary/20 to-primary/5 z-10 opacity-90"></div>
                            <img
